/*
 *  drivers/cpufreq/cpufreq_king.c
 *
...
#define MAX_SAMPLING_DOWN_FACTOR		(110000)
#define MICRO_FREQUENCY_DOWN_DIFFERENTIAL	(3)
#define MICRO_FREQUENCY_UP_THRESHOLD		(95)
#define MICRO_FREQUENCY_MIN_SAMPLE_RATE		(11000)
#define MIN_FREQUENCY_UP_THRESHOLD		(11)
#define MAX_FREQUENCY_UP_THRESHOLD		(100)
#define DEF_TARGET_RESIDENCY			(11000)
...
static
#endif
struct cpufreq_governor cpufreq_gov_king = {
    .name                   = "king",
...
static int __init cpufreq_gov_dbs_init(void)
{
    ...
    return cpufreq_register_governor(&cpufreq_gov_king);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
    cpufreq_unregister_governor(&cpufreq_gov_king);
}
...
MODULE_AUTHOR("RMS");
MODULE_DESCRIPTION("'cpufreq_king' - A dynamic cpufreq governor for "
		   "Low Latency Frequency Transition capable processors");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_KING
